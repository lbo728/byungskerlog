...
export function SocialMediaLinks({ linkedinUrl, threadsUrl }: SocialMediaLinksProps) {
  ...
  return (
    <div className="social-media-links flex flex-wrap gap-2">
      {linkedinUrl && (
        <Button variant="outline" size="sm" onClick={() => window.open(linkedinUrl, "_blank")} className="gap-2">
      ...
      {threadsUrl && (
        <Button variant="outline" size="sm" onClick={() => window.open(threadsUrl, "_blank")} className="gap-2">
          <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
